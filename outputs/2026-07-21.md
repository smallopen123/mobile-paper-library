...
generated_at: "2026-07-21T10:49:42+08:00"
generator_commit: "c8b779c2de5d63418193015ed532c6b174c1a3d6"
source_run_url: "https://github.com/smallopen123/mobile-paper-library/actions/runs/29796831729"
generation_status: "partial"
email_status: "sent"
item_count: 11
source_errors: ["Only 1 of 20 requested new papers were available", "SkyVLaM: Multimodal Large Language Model for UAV Video Understanding in Remote Sensing: PDF exceeds 26214400 bytes", "Only 0 of 10 papers had a downloadable, extractable PDF"]
---

# 低空经济通用大模型前沿论文库 - 2026-07-21
...
- SkyVLaM: Multimodal Large Language Model for UAV Video Understanding in Remote Sensing: PDF exceeds 26214400 bytes
...
| ---: | --- | --- | --- | --- | --- |
| 1 | 近30天回看（首次收录 2026-07-20） | 认识自我，理解世界：基于多模态大模型的无人机时空推理双认知基准 | Knowing the Self, Understanding the World: A Dual-Cognition Benchmark for UAV Spatio-temporal Reasoning with MLLMs | verified | found |
| 2 | 近30天回看（首次收录 2026-07-18） | CosFly-VLA：一种用于无人机跟踪的空间感知视觉-语言-动作模型 | CosFly-VLA: A Spatially Aware Vision-Language-Action Model for UAV Tracking | verified | found |
| 3 | 近30天回看（首次收录 2026-07-17） | 空间中的自我：无人机具身智能中自我意识与空间认知的基准测试 | Self in Space: Benchmarking Self-Awareness and Spatial Cognition in UAV Embodied Intelligence | verified | found |
| 4 | 近30天回看（首次收录 2026-07-16） | 空间中的自我：无人机具身智能中自我意识与空间认知的基准测试 | Self in Space: Benchmarking Self-Awareness and Spatial Cognition in UAV Embodied Intelligence | verified | found |
| 5 | 近30天回看（首次收录 2026-07-15） | 面向高分辨率近距多光谱遥感影像的自监督训练 | Self-supervised training for high-resolution close-range multispectral remote sensing imagery | verified | not_found |
| 6 | 近30天回看（首次收录 2026-07-15） | 解析、搜索与确认：基于思维链推理与结构化空间记忆的免训练空中视觉对话导航 | Parse, Search, and Confirmation: Training-Free Aerial Vision-and-Dialog Navigation with Chain-of-Thought Reasoning and Structured Spatial Memory | verified | found |
| 7 | 近30天回看（首次收录 2026-07-14） | 面向野外无人机的主动目标检测：大规模数据集、基准与方法 | Toward Active Object Detection for UAVs in the Wild: A Large-Scale Dataset, Benchmark and Method | verified | found |
| 8 | 近30天回看（首次收录 2026-07-14） | PanoWorld：真实世界全景视频生成 | PanoWorld: Real-World Panoramic Generation | verified | found |
| 9 | 近30天回看（首次收录 2026-07-13） | 面向无人机航空机器人与双臂操作的视觉-语言-动作（VLA）模型综述 | Vision Language Action (VLA) Models for Unmanned Aerial Robotics and Bimanual Manipulation: A Review | verified_first_40_pages | found |
| 10 | 近30天回看（首次收录 2026-07-13） | UAV-OVVIS：无人机也需要开放词汇视频实例分割 | UAV-OVVIS: Unmanned Aerial Vehicles Also Need Open-Vocabulary Video Instance Segmentation | verified | found |
...
网页版本：https://smallopen123.github.io/mobile-paper-library/2026-07-21/
...
## Top 2. CosFly-VLA：一种用于无人机跟踪的空间感知视觉-语言-动作模型
...
## Top 3. 空间中的自我：无人机具身智能中自我意识与空间认知的基准测试
...
## Top 4. 空间中的自我：无人机具身智能中自我意识与空间认知的基准测试
...
## Top 6. 解析、搜索与确认：基于思维链推理与结构化空间记忆的免训练空中视觉对话导航
...
## Top 7. 面向野外无人机的主动目标检测：大规模数据集、基准与方法
...
## Top 9. 面向无人机航空机器人与双臂操作的视觉-语言-动作（VLA）模型综述
...
- Entry type: 近30天回看（首次收录 2026-07-13）
...
```mermaid
flowchart LR
  N0["输入/场景: 摄像头图像 + 语言指令 + 本体感知状态"]
  N1["核心模块: VLA架构 (自回归/流匹配/扩散/混合) + 动作头"]
  N2["机制: 动作分块 (Action Chunking) + 流匹配/扩散去噪"]
  N3["输出: 连续动作块 (Action Chunk) 或离散动作令牌"]
  N4["指标: Task success rate, Inference latency, Data efficiency, Generalization ratio"]
  N0 --> N1
  N1 --> N2
  N2 --> N3
  N3 --> N4
...
## Top 10. UAV-OVVIS：无人机也需要开放词汇视频实例分割
...
```mermaid
flowchart LR
  N0["输入/场景：UAV视频 + 开放词汇文本查询"]
  N1["核心模块：Recognizer（YOLO-World/Grounding DINO/SAM3）周期性开放词汇检测"]
  N2["核心模块：Segmenter（SAM2/SAM3）短片段掩码生成与传播"]
  N3["机制：LIA输出级跨片段ID关联，维护全局身份"]
  N4["输出：实例级分割轨迹（全局一致ID）"]
  N5["指标：HOTA, mAP, DetA, AssA, Mask J"]
  N0 --> N1
  N1 --> N2
  N2 --> N3
  N3 --> N4
...
> [!info]- 11. SkyVLaM：面向遥感无人机视频理解的多模态大语言模型
> - English Title: SkyVLaM: Multimodal Large Language Model for UAV Video Understanding in Remote Sensing
> - 中文摘要：多模态大语言模型的最新进展显著提升了遥感多模态理解能力。语言条件分割对于无人机视频中细粒度目标理解至关重要。然而，由于小尺寸、视觉模糊的目标以及动态空中视角的普遍存在，该任务仍具挑战性。本文提出SkyVLaM，一种用于无人机视频理解的多模态大语言模型。SkyVLaM通过时间基感知器直接从块级视频表示构建稀疏令牌，正则化稀疏基以鼓励互补时间线索，并自适应选择时间连贯的密集片段进行高分辨率检查。生成的稀疏和密集令牌由大语言模型联合处理，用于查询条件分割。我们进一步构建了SkyVid数据集，包含SkyVid-VGCG和SkyVid-RVOS，分别用于视频基础对话生成和参考视频对象分割。SkyVid包含101个视频、33.6K帧和153万个像素级对象实例。实验表明，SkyVLaM提供了更有效的视觉令牌预算分配，并改善了无人机场景下的语言条件视频分割。
...
> - 核心贡献/相关性：该工作直接面向低空无人机视频理解，其多模态大语言模型架构（稀疏令牌与密集片段联合处理）可迁移至低空场景通用大模型的基础模型设计。模型中的语言条件分割机制对低空场景中的安全评估（如目标检测与跟踪）具有参考价值。边缘部署方面，稀疏令牌策略有助于降低计算开销，但需进一步验证在资源受限设备上的可行性。
> - 证据等级：secondary / abstract-only
> - [Original Page](http://arxiv.org/abs/2607.17386v1) | [PDF](http://arxiv.org/pdf/2607.17386v1)
